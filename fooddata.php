...
<!---------------------------SignUP Box Is Start  -->
    <div id="id02"  class="modal">
            ...
            <div class="imgcontainer">
                ...
                <img src="image/foodmood.png" style="width: 200px; height: 200px;" alt="Head image" class="avatar">
            </div>
    
            <div class="container" style="widht:10px" >
                <label for="uname"><b>Enter The Username</b></label>
                <input type="text" placeholder="Enter Username" title="Please enter your favorite name" name="uname" required>
               
                <label  for="Login" ><b>Enter The Email-Id</b></label>
    ...
    <div id="id01" class="modal">
        ...
        <form class="modal-content"  action="login2.php" method="POST" >
            ...
            <div class="container">
                ...
                <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="example@example.com" placeholder="Enter Username" name="emailid" required>

                <label for="psw"><b>Password</b></label>
                <input type="password" placeholder="Enter Password" pattern=".{8,}"   title="Enter the valid Email Id" name="psw" required>
            ...
            <div class="container" style="background-color:#f1f1f1">
                <button type="button" onclick="document.getElementById('id01').style.display='none'"
                    class="cancelbtn">Cancel</button>
                <span class="psw"><a href="forgotpw.html"  style="text-decoration-line: none;">Forgot password?</a></span>
            </div>
        </form>
    </div>
