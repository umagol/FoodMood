...
<body style="background-image: url(FM.png);">
...
$data=pg_query("select * from food where foodname='$foodname'");
...
echo "
        ...
        <div class='card card-outline-secondary my-4'>
          ...
          <div class='card-body'>
            ...
            <button name='foodname' value='$foodname'>
            <a class='btn btn-success'>Delete Food</a>
          <button>
          <form>
          </hr>
